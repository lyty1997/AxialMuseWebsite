    ...
    <Layout>
      ...
      <main className={styles.page}>
        <header className={styles.hero}>
          <h1>Axial Muse</h1>
          <p className={styles.lede}>围绕个人项目，记录设计、实现、技术取舍与复盘。</p>
          <p className={styles.stage}>首版先公开可核验的项目资料和工程记录。产品服务会在边界明确并真实可用后再提供入口。</p>
          <Link className={styles.primaryLink} to="/projects/">浏览项目</Link>
        </header>
