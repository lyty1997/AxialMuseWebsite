...
export const JAVASCRIPT_SOURCE_FILES = Object.freeze([
  ...
  "scripts/quality/lib/file-tree.mjs",
  "scripts/quality/lib/plantuml.mjs",
  "scripts/quality/lib/process-environment.mjs",
  "scripts/quality/lib/ci-workflow.mjs",
  "scripts/quality/lib/deploy-workflow.mjs",
  "scripts/quality/lib/content-history.mjs",
  "scripts/quality/lib/production-artifact-outputs.mjs",
  "scripts/quality/lib/production-artifact-workspace.mjs",
  ...
  "scripts/deploy/lib/bounded-json-http.mjs",
  "scripts/deploy/lib/production-deploy-identity.mjs",
  "scripts/deploy/lib/production-deploy.mjs",
  "scripts/deploy/lib/tencent-tat.mjs",
  "scripts/deploy/check-production-deploy-identity.mjs",
  "scripts/deploy/dispatch-production.mjs",
  ...
  "scripts/release/check-runtime-redirects-nginx.mjs",
  "scripts/release/package-site.mjs",
  "scripts/author/create-article.mjs",
  "scripts/author/run-create-article-tests.mjs",
  "scripts/author/run-set-article-dates-tests.mjs",
  ...
  "scripts/quality/check-production-artifact-outputs.mjs",
  "scripts/quality/check-production-artifact-workspace.mjs",
  "scripts/quality/prepare-production-artifact-upload.mjs",
  ...
  "scripts/quality/check-release-package.mjs",
  ...
  "tests/build/deploy-workflow.test.mjs",
  "tests/build/bounded-json-http.test.mjs",
  "tests/build/production-deploy-identity.test.mjs",
  "tests/build/production-deploy.test.mjs",
  "tests/build/tencent-tat.test.mjs",
  ...
  "tests/build/runtime-redirects.test.mjs",
  "tests/build/file-tree.test.mjs",
  "tests/build/release-package.test.mjs",
  "tests/build/production-artifact-outputs.test.mjs",
  "tests/build/production-artifact-workspace.test.mjs",
  ...
  "tests/build/run-set-article-dates-tests.test.mjs",
