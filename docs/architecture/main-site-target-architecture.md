...
- 把 E-001 至 E-015 转化为内容 schema、注册表、路径与路由检查、主题 fit-gap、侧栏/SEO 投影、主预览与素材白名单、局域网候选切换、隔离 npm 入口、确定性 SPDX、Node ESM 测试、完整 Git 历史、同版本服务端 301、production build 字节闭包、Node 24 双端点、静态构建和 artifact 制品检查；#5 至 #14 的实现与 fixture 继续由对应 Issue 跟踪。
