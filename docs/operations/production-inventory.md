...
|---|---|---|---|---|
| DocRestore | `docrestore.axialmuse.com` | `planned` / `onlineExperience: false` | 主站项目说明、GitHub 仓库、演示视频 | 禁止创建 |
...
| 日期 | 变更 | 原因 | 验证 |
|---|---|---|---|
| 2026-07-13 | DocRestore 改为“公开仓库 + 演示视频”，明确不提供在线体验 | 用户确认自有后端只用于私有运行和录制，首版不承担公网服务 | 注册表禁止 DNS provisioning；视频素材尚待准备 |
